...
const operations = [
  { _tag: "EnsureRuntime", sessionId: "session-a", operationId: "ensure" },
  { _tag: "InspectRuntime", sessionId: "session-a", operationId: "inspect" },
  {
    _tag: "ExecRuntime",
    sessionId: "session-a",
    operationId: "exec",
  ...
  { _tag: "StopRuntime", sessionId: "session-a", operationId: "stop" },
  { _tag: "RemoveRuntime", sessionId: "session-a", operationId: "remove" },
