...
describe("ArtifactStore", () => {
  for (const factory of [
    ...
    it.effect(`publishes and opens only verified private PNGs through the ${factory.name}`, () =>
      Effect.gen(function* () {
        ...
        assert.strictEqual(artifact.objectKey, "evidence/a0b1c2d3e4f5/job-1/frame-1.png");
  ...
  it.effect("publishes and opens a verified browser-recorded WebM", () =>
    Effect.gen(function* () {
      ...
      assert.strictEqual(artifact.objectKey, "evidence/a0b1c2d3e4f5/job-1/recording.webm");
