...
import sessionHtml from "../public/session.html?raw";

const sessionCss = readFileSync(new URL("../public/session.css", import.meta.url), "utf8");
...
describe("cloud-agent session application", () => {
  it("wires one semantic shell to the five focused native modules", () => {
    ...
    assert.include(sessionHtml, '<script type="module" src="/app.js"></script>');
