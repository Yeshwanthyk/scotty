...
import { credentialCryptoLayer, directWorkerSecretInstallationWrappingKeyLayer } from "./crypto";
import {
...
const toResolvedCredentialWire = (
  ...
  const decoded = decodeCredentialRegistryResolvedCredentialResult({ value });
