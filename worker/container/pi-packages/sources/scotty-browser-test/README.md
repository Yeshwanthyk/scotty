...
closes. Recorded jobs briefly hold every verified step result and hold the final result longer,
making the video easier to follow without changing the bounded job contract. Browser, preview,
storage, and session authority remain outside the container.
