...
license: MIT
compatibility: Scotty with Effect 4.0.0-rc.112; verify Schema APIs against vendor/effect.
---
...
Verify decoder names and signatures against `vendor/effect/packages/effect/src/Schema.ts` and rc.112 tests. Do not use Effect v3 Schema imports.
