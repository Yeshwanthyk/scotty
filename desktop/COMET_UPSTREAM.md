...
Scotty Desktop was bootstrapped from selected presentation assets in
...
Scotty does **not** import Comet's engine, harness, CRDT documents, sync, RPC
server, Edge Worker, credential accounts, updater, or persisted state. The
runtime boundary remains Scotty's Worker, Sandbox Durable Object, and existing
Pi supervisor.
