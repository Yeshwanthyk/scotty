...
const CODEX_NATIVE_INPUTS = Object.freeze([
  ...
  exact("protocol/runtime/runtime-cli-manifest.ts"),
  exact("protocol/runtime/runtime-cli-pin.ts"),
  exact("protocol/runtime/runtime-image-compatibility.ts"),
