...
import noErrorSubclass from "./oxlint-plugin-scotty/rules/no-error-subclass.js";
...
import noStorageKeyLiteral from "./oxlint-plugin-scotty/rules/no-storage-key-literal.js";
...
export default {
  ...
  rules: {
    ...
    "no-error-subclass": noErrorSubclass,
    ...
    "no-storage-key-literal": noStorageKeyLiteral,
